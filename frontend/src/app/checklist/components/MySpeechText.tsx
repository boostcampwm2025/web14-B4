    ...
    <div className="w-full max-w-2xl mx-auto bg-white p-5">
      ...
      <div className="mb-6">
        <textarea
          ...
          className="rounded-xl p-6 border-2 mb-6 w-full h-[700px] resize-none text-gray-800 text-lg leading-relaxed focus:outline-none focus:ring-2 focus:ring-blue-400 overflow-y-auto custom-scrollbar"
