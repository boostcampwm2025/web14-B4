  ...
  return (
    <div className="mx-auto w-full max-w-[720px] px-4">
      <div className="rounded-xl border border-gray-200 bg-white p-4">
        <textarea
          id="text-answer"
          className="rounded-xl p-6 border-2 mb-6 w-full min-h-[400px] resize-none overflow-y-auto text-gray-800 text-lg leading-relaxed focus:outline-none focus:ring-2 focus:ring-blue-400 textarea-scrollbar"
      ...
      <Popup
        ...
        description="작성중인 답변이 제출되지 않습니다."
